...
export default class ApplyBanner extends Component {
  render(){
    return <div className="apply-banner footer">
      <div className="item">
        {this.props.children} <a href="https://progressivetalentpipeline.applytojob.com/apply/BFlTRQV7hB/2023-Progressive-Talent-Pipeline-Application" target="_blank">Apply now&nbsp;></a>
      </div>
      <div className="item">
