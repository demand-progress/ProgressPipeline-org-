    ...
    render(){
        return(
            <div>
                ...
                <iframe style={{display: this.state.pageLoaded ? 'block': 'none'}} src="https://script.google.com/macros/s/AKfycbyBk0pVaexA-mycr5xX1zZM4P7cVu-FblAfhEc_KwMNqkOVWA/exec" frameBorder="0" scrolling="no"></iframe> 
